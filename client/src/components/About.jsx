        ...
        <div className="px-2 flex max-w-screen-lg mx-auto pt-5 items-center flex-col">
          ...
          <div className="flex items-center">
            <p className="text-xl text-green-400 font-medium mt-10 w-96 text-right mr-16">
              Lorem ipsum dolor, sit amet consectetur adipisicing elit. Odio non maxime nihil vel
              esse fugit at debitis repellendus porro. Autem consequatur dolore et dolorum eaque
              aperiam odit, perspiciatis consequuntur voluptate, obcaecati impedit quod ad. Facilis
              fuga tempore, nihil molestias, debitis vero est quasi reiciendis itaque cupiditate
              eaque id illum sint aut nisi amet. Exercitationem ad, ducimus fugit sit magni
              pariatur.
            </p>
